...
El objetivo final del cliente es maximizar el reconocimiento de los documentos para reducir el ingreso de datos manual. Resulta muy importante el tiempo que demore el procesamiento de cada documento ya que podría incorporarse en soluciones donde la captura y reconocimiento sean necesarios para la decisión del destino del mismo.
