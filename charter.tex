...
El set de datos contiene información privada que no podrá ser publicada sin antes anonimizar o difuminar.
...
Identificar documentos con un formato predeterminado y homogéneo, que abarque todas las etapas, desde el preprocesamiento de la imagen, hasta el análisis, identificación y validación del resultado obtenido.
